...
** Installation
   ...
   The =install.sh= scritp provide all information about the system.
...
*** More details about the script
    ...
    benchmark output will be on =knl/reduc= directory.

    *IMPORTANT NOTE:* It store *BRUT* output in *.txt* files and plot
    data in *.dat* files.
