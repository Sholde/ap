...
*** ntstore
    ...
    I know that standart derivation of *reduc_SSE_16B* is average 10%
    and it is not an evaluble performance but I run 20 times the
    bencmark and it was each time at 10%.
